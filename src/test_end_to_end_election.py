...
class TestEndToEndElection(TestCase):
    ...
    def test_end_to_end_election(self, data) -> None:
        """
        Execute the simplified end-to-end test demonstrating each component of the system.
        """
        self.step_0_configure_election() # safe, no writing done
    ...
    def step_2_encrypt_votes(self, data) -> None:
        """
        ...
        # Load some Ballots
        self.plaintext_ballots = BallotFactory().get_ballots_from_string(data)
        self._assert_message(
...
def interface():
    print("President Candidates!")
    print("Candidate #1: Funny Valentine - Blue")
    print("Candidate #2: Senarator Armstrong - Red")
...
if __name__ == "__main__":
    ...
    data = interface()
    TestEndToEndElection().test_end_to_end_election(data)
